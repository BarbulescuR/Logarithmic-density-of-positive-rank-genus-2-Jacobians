/*
Purpose: Elkies 2015 simple genus-2 example data used by HighRankSimpleJacobianExamples.m.
Paper location: Appendix A.1 curve/example data file.
Usage: load "Elkies29gen2.m";
Output: defines f, C, and xs for the rank/height helper.
Reference: Noam Elkies, Simple genus-2 Jacobian of rank at least 29,
message to the NMBRTHRY list, 2015.
*/
